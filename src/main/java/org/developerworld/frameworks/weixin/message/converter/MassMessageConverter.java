...
public class MassMessageConverter {
	 ...
	 * @throws IOException
	 */
	public String convertToAllJson(MassMessage massMessage)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public String convertToGroupJson(MassMessage massMessage,String groupId)
			throws IOException {
		Map root = new LinkedHashMap();
		Map filter = new LinkedHashMap();
	 ...
	 * @throws IOException
	 */
	public String convertToToUsersJson(MassMessage massMessage,List<String> tousers)
			throws IOException {
		Map root = new LinkedHashMap();
	 ...
	 * @throws IOException
	 */
	public String convertToToUserJson(MassMessage massMessage,String openId)
			throws IOException {
		Map root = new LinkedHashMap();
